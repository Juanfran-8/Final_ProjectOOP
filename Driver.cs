...
namespace Final_ProjectOOP
{
    internal class Driver : Worker
    {
        ...
        {
            AddTask();
            Console.WriteLine($"{GetName()} is driving a vehicle with license type {licenseType}.");
        }

        public override void Display()
        {
            Console.WriteLine($"Driver ID: {GetId()}, Name: {GetName()}, License Type: {licenseType}, Performance: {CalculatePerformance()}");
        }
    }
}
