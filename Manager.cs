...
namespace Final_ProjectOOP
{
    public class Manager : Worker
    {
        ...
        {
            AddTask();
            Console.WriteLine($"{GetName()} is managing a team of {teamSize} workers.");
        }
        ...
        {
            Console.WriteLine($"Manager ID: {GetId()}, Name: {GetName()}, Team Size: {teamSize}, Performance: {CalculatePerformance()}");
        }
    }
}
